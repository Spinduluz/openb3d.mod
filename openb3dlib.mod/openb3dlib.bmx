...
Const ANIMATION_class:Int=		1
Const ANIMATIONKEYS_class:Int=	2
Const BONE_class:Int=			3
Const BRUSH_class:Int=			4
Const CAMERA_class:Int=			5
Const COLLISION_class:Int=		6 ' collision.h
Const COLLISIONINFO_class:Int=	7
Const COLLISIONPAIR_class:Int=	8 ' collision2.h
Const COLLISIONIMPACT_class:Int=9
Const CSGTRIANGLE_class:Int=	10 ' csg.h
Const ENTITY_class:Int=			11
Const VECTOR_class:Int=			12 ' geom.h
Const LINE_class:Int=			13
Const PLANE_class:Int=			14
Const QUAT_class:Int=			15
Const MMATRIX_class:Int=		16
Const BOX_class:Int=			17
Const TRANSFORM_class:Int=		18
Const GEOSPHERE_class:Int=		19
Const GLOBAL_class:Int=			20
Const FLUID_class:Int=			21 ' isosurface.h
Const BLOB_class:Int=			22
Const FIELDARRAY_class:Int=		23
Const LIGHT_class:Int=			24
Const MATERIALPLUGIN_class:Int=	25 ' material.h
Const MATRIX_class:Int=			26
Const MESH_class:Int=			27
Const OCTREE_class:Int=			28 ' octree.h
Const OCTREECHILD_class:Int=	29
Const PARTICLEBATCH_class:Int=	30 ' particle.h
Const PICK_class:Int=			31
Const PIVOT_class:Int=			32
Const QUATERNION_class:Int=		33
Const SHADERDATA_class:Int=		34 ' shadermat.h
Const SAMPLER_class:Int=		35
Const MATERIAL_class:Int=		36
Const SHADER_class:Int=			37
Const SHADEROBJECT_class:Int=	38 ' shaderobject.h
Const PROGRAMOBJECT_class:Int=	39
Const SHADOWTRIANGLE_class:Int=	40 ' shadow.h
Const EDGE_class:Int=			41
Const SHADOWOBJECT_class:Int=	42
Const SPRITE_class:Int=			43
Const SPRITEBATCH_class:Int=	44
Const STENCIL_class:Int=		45
Const SURFACE_class:Int=		46
Const TERRAIN_class:Int=		47
Const TEXTURE_class:Int=		48
Const TEXTUREFILTER_class:Int=	49
Const TILT_class:Int=			50
Const TOUCH_class:Int=			51
Const MESHCOLLIDER_class:Int=	52 ' tree.h
Const MESHINFO_class:Int=		53
Const VOXELSPRITE_class:Int=	54 ' voxel.h
